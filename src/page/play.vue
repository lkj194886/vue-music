<template>
  <div style="width: 100%" id="play">
    <aplayer
      :music="{
    title: '情非得已',
    artist: '童声版',
    src: 'http://m8.music.126.net/20200630014458/390c22e201dd55a57e4f1efe5d5edb00/ymusic/0fd6/4f65/43ed/a8772889f38dfcb91c04da915b301617.mp3',
...
export default {
  ...
  data() {
    return {
      musicid: this.$route.params.playid,
      videoUpload: {
        progress: false,
        progressPercent: 0,
        successPercent: 0,
